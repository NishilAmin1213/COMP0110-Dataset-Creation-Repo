...
def main():
    ...
    store_candidate_functions(res_candidate_functions_same_params, "candidate_functions_same_params.pkl")
    store_candidate_functions(res_candidate_functions_different_params, "candidate_functions_different_params.pkl")


if __name__ == '__main__':
    print("")
    main()
    read_candidate_functions("candidate_functions_same_params.pkl")
    read_candidate_functions("candidate_functions_different_params.pkl")
